...
public class AudioManager implements Runnable {
    ...
    private BlockingQueue<AudioCommand> audioQueue = new LinkedBlockingQueue<>();

    // Clips de áudio carregados
    private Map<String, Clip> loadedClips = new HashMap<>();
    ...
    private Clip getOrLoadClip(String fileName) {
        ...
        try {
            ...
            try (var audioStream = AudioSystem.getAudioInputStream(
                    getClass().getResourceAsStream("/audio/" + fileName))) {
